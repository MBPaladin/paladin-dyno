...
class Controller(Master):
    ...
    def _sensor_snapshot(self):
        """Live torque-cell and position readings for behaviors that need
        telemetry (the multisine preamble anchors its amplitude to the cells'
        measured noise floor and watches position drift). Runs on the control
        ...
        return {'torque': torque, 'position': position}
